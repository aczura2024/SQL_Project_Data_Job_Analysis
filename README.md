...
To understand more about the data analytcs job market in Canada in 2023, such as the top-paying jobs, most in-demand skills,  I used this data to conduct various relevant queries.
...
# The Analysis
Each of the 5 queries was aimed at answering a different question relating to the data analytics job market in Canada in 2023. Below I give a description of how each question is answered. 



**1. 10 Highest Paid Data Analyst Jobs in Canada in 2023**
...
*Bar graph visualizing the salary for the top 10 salaries for Canadian data analysts; this graph was generated by ChatGPT based on my SQL query results*


**2. Skills Needed in Canada's Top-Paying Data Analyst Jobs in 2023**
...
ORDER BY
    salary_year_avg DESC
```
Here is a summary of the most demanded skills for the top 10 highest paying data analyst jobs in Canada in 2023:
* Python and SQL lead the charge with the highest count at 8.
* Tableau, Excel and Spark follow with 3 occurrences each/
* Other skills such as SAS have varying degrees of demand.



![](Query_2_Skill_Count_for_Top_10_Data_Analyst_Jobs_Canada.png)
*Bar graph visualizing the count of skills for the top 10 paying jobs for data analysts; this graph was generated by ChatGPT from my SQL query output*
...
**4. Data Analyst Skills Ranked By Salary in Canada in 2023**
...
```
Here's a summary of the results of the top paying skills for data analysts in Canada in 2023:
...
**5. Most Important Skills to Learn for Canadian Data Analyst Jobs in 2023**
This query extracts both the skills that are in the highest demand and highest paying for data analyst jobs in Canada in 2023.
...
* The highest paying data analyst jobs are with large financial services corporations, such as Stripe and Sun Life.
* The most sought after skills are fundamental data maipulation platforms such as SQL and Excel, with Python also trailing behind. 
* The highest paying skill in Canada is TypeScript.
* I should focus on learning additonal skills such as Tableau which is also commonly asked for in a job posting.
